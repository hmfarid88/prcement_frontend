...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getDatewiseExpense?username=${encodeURIComponent(username)}&startDate=${startDate}&endDate=${endDate}`)
    ...
    const handleEdit = (id: number) => {
        ...
        router.push(`/expense-edit?id=${encodeURIComponent(id)}`);
        ...
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] p-4 items-center justify-center">
                ...
                <div className="flex w-full justify-between pl-5 pr-5 pt-1">
                    ...
                    <ExcelExport tableRef={contentToPrint} fileName="datewise_expense_report" />
