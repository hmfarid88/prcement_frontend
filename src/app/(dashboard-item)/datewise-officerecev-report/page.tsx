...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getDatewiseOfficeReceive?username=${encodeURIComponent(username)}&startDate=${startDate}&endDate=${endDate}`)
 ...
 const handleEdit = (id: number) => {
        ...
        router.push(`/officereceive-edit?id=${id}`);
        ...
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] p-4 items-center justify-center">
                ...
                <div className="flex w-full justify-between pl-5 pr-5 pt-1">
                    ...
                    <ExcelExport tableRef={contentToPrint} fileName="datewise_emp_pay_report" />
                ...
                <div className="flex w-full justify-center">
                    <div className="overflow-x-auto">
                        <div ref={contentToPrint} className="flex-1 p-5">
                            <div className="flex flex-col items-center pb-5"><h4 className="font-bold">CASH RECEIVE REPORT</h4>
