...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getDatewiseSupplierPayment?username=${encodeURIComponent(username)}&startDate=${startDate}&endDate=${endDate}`)
    ...
    const handleEdit = (id: number) => {
        ...
        router.push(`/supplierpay-edit?id=${id}`);
