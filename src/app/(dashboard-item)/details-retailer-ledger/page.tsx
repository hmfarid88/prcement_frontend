...
useEffect(() => {
  ...
  const handleSubmit = (e: any) => {
    ...
    router.push(`/dateTodate-retail-details?username=${encodeURIComponent(username ?? "")}&retailerName=${encodeURIComponent(retailerName ?? "")}&startDate=${startDate}&endDate=${endDate}`);
    setStartDate("");
    setEndDate("");
  };
