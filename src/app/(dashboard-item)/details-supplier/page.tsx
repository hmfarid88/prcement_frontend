...
const Page = () => {
    ...
    const totalValue = filteredProducts.reduce((sum, p) => sum + (p.productValue || 0), 0);
    const totalPayment = filteredProducts.reduce((sum, p) => sum + (p.payment || 0), 0);
    const totalCommission = filteredProducts.reduce((sum, p) => sum + (p.commission || 0), 0);
                            ...
                            <table className="table table-xs md:table-sm table-pin-rows table-zebra">
                                ...
                                <tfoot>
                                    <tr className="font-bold bg-base-200">
                                        ...
                                        <td>{Number(totalCommission.toFixed(2)).toLocaleString('en-IN')}</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
