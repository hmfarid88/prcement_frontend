...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getOfficePay?username=${encodeURIComponent(username)}`)
    ...
    return (
        <div className="container-2xl">
            ...
            <div className="flex p-5 justify-end items-end"><DateToDate routePath="/datewise-officepay-report" /></div>
                    ...
                    <div className="flex w-full justify-between pl-5 pr-5 pt-1">
                      ...
                      <div className="flex gap-2">
                        <ExcelExport tableRef={contentToPrint} fileName="officepay_report" />
