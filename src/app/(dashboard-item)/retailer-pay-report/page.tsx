...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getRetailerPayment?username=${encodeURIComponent(username)}`)
    ...
    return (
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] items-center justify-center p-4">
                <div className="flex p-5 justify-end items-end"><DateToDate routePath="/datewise-retailerpay-report" /></div>
                ...
                <div className="flex w-full justify-between pl-5 pr-5 pt-1">
                    ...
                    <div className="flex gap-2">
                        <ExcelExport tableRef={contentToPrint} fileName="retailer_pay_report" />
