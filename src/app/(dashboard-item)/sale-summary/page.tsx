...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/api/datewise-sale-summary?username=${encodeURIComponent(username)}&startDate=${startDate}&endDate=${endDate}`)
                    ...
                    <div className="flex w-full justify-center p-5">
                        <div className="overflow-x-auto">
                            <div ref={contentToPrint} className="flex-1 p-5">
                                <div className="flex flex-col items-center pb-5"><h4 className="font-bold">SALES SUMMARY</h4>
