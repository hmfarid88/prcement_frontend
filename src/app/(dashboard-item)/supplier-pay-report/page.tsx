...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getSupplierPay?username=${encodeURIComponent(username)}`)
    ...
    return (
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] items-center justify-center p-4">
                <div className="flex p-5 justify-end items-end"><DateToDate routePath="/datewise-supplierpay-report" /></div>
                ...
                <div className="flex w-full justify-between pl-5 pr-5 pt-1">
                    ...
                    <div className="flex gap-2">
                        <ExcelExport tableRef={contentToPrint} fileName="supplier_pay_report" />
                ...
                <div className="flex w-full justify-center">
                    <div className="overflow-x-auto">
                        <div ref={contentToPrint} className="flex-1 p-5">
                            <div className="flex flex-col items-center pb-5"><h4 className="font-bold">SUPPLIER PAYMENT REPORT</h4><CurrentMonthYear /></div>
